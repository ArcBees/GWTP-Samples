...
public class ResponsePresenter extends Presenter<ResponsePresenter.MyView, ResponsePresenter.MyProxy> {
    ...
    protected void onReset() {
        ...
        dispatcher.execute(textService.getText(textToServer), new AsyncCallback<SendTextResult>() {
            @Override
            ...
            @Override
            public void onSuccess(SendTextResult result) {
                getView().setServerResponse(result.getText());
            }
        });
    }
}
